...
const es = {
  ...
  hero: {
    ...
    /* Describe la FOTO, no la app: quien no la ve necesita saber que hay una
       persona real sujetando el teléfono, que es lo que la foto aporta. El
       recorrido de dentro ya se anuncia por su cuenta. */
    fotoAlt: "Henry, fundador de ANDEX, sujetando un teléfono con la app abierta.",
    /**
...
const en = {
  ...
  hero: {
    ...
    fotoAlt: "Henry, founder of ANDEX, holding a phone with the app open.",
    mockup: {
